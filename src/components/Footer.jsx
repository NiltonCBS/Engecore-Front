...
export function Footer() {
  ...
  return (
    ...
    <div className="ml-60 border-t border-slate-900/5 py-5">
        <p className=" text-center text-sm leading-6 text-slate-500">© 2022 Tailwind Labs Inc. All rights reserved.</p>
